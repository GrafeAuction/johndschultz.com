---
title: "Understanding vs. Doing"
date: 2025-12-10
description: "Why collecting wisdom is easier than applying it."
tags: ["principles", "decision-making"]
series: []
ShowToc: true
TocOpen: false
draft: false
...
I wrote down that "laziness is a deep indicator from within you that you're not doing something right with your own life." Fair enough. But what about the opposite? What about industrious note-taking that _feels_ productive but is actually avoidance behavior dressed up as preparation?
...
Here's what makes this pattern so persistent: collecting knowledge _does_ have value. Understanding principles _is_ useful. The problem is when it becomes a substitute for action rather than a foundation for it.
...
The answers are obvious when you force the temporal perspective. Yet in the present moment, acquiring knowledge _feels_ like progress.
...
Jordan Peterson says that when you set a goal, your perception reorganizes around it. The world arranges itself as a pathway to that goal. But that only works if the goal is _doing something_, not _understanding something_.

...
date: 2025-09-22
description: "Why 'we've seen this before' is the laziest thing you can say."
tags: ["history", "leadership", "principles"]
series: []
ShowToc: true
TocOpen: false
draft: false
...
1. **What's the pattern?** Which historical parallel are you actually seeing?
2. **What's genuinely similar?** Same human psychology? Same structural conditions?
3. **What's fundamentally different?** New technology, new regulations, different global context?
4. **What created the original pattern?** Not just what happened, but why it happened.
5. **How have those causes evolved?** The trigger from 1929 doesn't fire the same way in 2008.
